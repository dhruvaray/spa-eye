...
function firebugFrameLoad(Firebug)
{
    ...
    // * spa_eye; is unique prefix of all messages that should be customized.
    // * DBG_SPA_EYE is a class name with style defined in the specified stylesheet.
...
function firebugFrameUnload(Firebug)
{
    ...
    Firebug.unregisterExtension("spa_eye");
    Firebug.unregisterTracePrefix("spa_eye;");
}
